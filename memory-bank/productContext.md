...
2. Configure embedding service (`go-rag config set ...`).
3. Add documents (`go-rag add <file>`).
4. Search (`go-rag search <query>`).
5. Inspect specific chunks (`go-rag get-chunk <doc-id> --index <n>`).
